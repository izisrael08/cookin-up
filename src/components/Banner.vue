<template> 
  <header class="banner">
    ...
    <img src="../assets/images/foto-banner.png" alt="foto de uma mulher cozinhando com uma bacia de vidro nas mãos. Ela está sorrindo e apoiando o celular entre o rosto e o ombro" class="foto-banner">
  </header>
</template>
